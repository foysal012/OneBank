...
class NewAndEventPageScreen extends StatefulWidget {
  const NewAndEventPageScreen({Key? key}) : super(key: key);

  @override
  State<NewAndEventPageScreen> createState() => _NewAndEventPageScreenState();
}

class _NewAndEventPageScreenState extends State<NewAndEventPageScreen> {
