...
class FundTransferPageScreen3 extends StatefulWidget {
  const FundTransferPageScreen3({Key? key}) : super(key: key);

  @override
  State<FundTransferPageScreen3> createState() => _FundTransferPageScreen3State();
}

class _FundTransferPageScreen3State extends State<FundTransferPageScreen3> {
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: InkWell(
                      onTap:(){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>BeneficiaryOtherBankPageScreen()));
                      },
                      child: Container(
                        height: 62,
                        width: 62,
